...
@extends("layouts.layout")
  <!-- ======= Hero Section ======= -->
  @section("title","MENASYS - 404")
  @section("content")
 
       
        <main>
          <div class="container containerrrr mg">
            <div class="row">
              <div class="col-md-6 align-self-center">
                <svg class="svgd" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 800 600">
                  <g>
                    <defs>
              ...
              <div class="col-md-6 align-self-center">
                <h1 title="404" class="hh1 glitch">404</h1>
                <h2 class="hh2">EUH OH ! Vous êtes perdu.</h2>
                <p>La page que vous recherchez n'existe pas.</p>
                <p>Comment êtes-vous arrivé ici est un mystère. Mais vous pouvez cliquer sur le bouton ci-dessous
                  pour revenir à la page d'accueil.
                </p>
                <button class="btn4 green">Accueil</button>
              </div>
            </div>
          </div>
        </main>
